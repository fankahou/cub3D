...
/*   Updated: 2025/05/02 23:47:24 by vagarcia         ###   ########.fr       */
/*                                                                            */
/******************************************************************************/
...
void	init_test_map(t_game *game)
{
    ...
    // Set proper map dimensions based on actual test map
    game->map.height = 12; // Number of rows in test_map array
    game->map.width = 18;  // Length of the longest string in test_map
    ...
    printf("Map loaded: %d rows by %d columns\n", game->map.height, game->map.width);
}

void	init_test_textures(t_game *game)
{
	game->textures[NORTH].path = ft_strdup("./textures4/north.xpm");
	game->textures[SOUTH].path = ft_strdup("./textures4/south.xpm");
	game->textures[EAST].path = ft_strdup("./textures4/east.xpm");
	game->textures[WEST].path = ft_strdup("./textures4/west.xpm");
